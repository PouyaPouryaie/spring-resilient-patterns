...
@Profile("annotation")
public class BulkheadAnnotationRatingServiceClient implements RatingServiceClient {

    private final RestClient restClient;

    @Bulkhead(name = "ratingServiceAnnotation", type = Bulkhead.Type.SEMAPHORE, fallbackMethod = "getRatingFallback")
